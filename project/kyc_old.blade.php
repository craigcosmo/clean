					...
					<div>
						...
						<div class="fg1 mb70">
							<div class="df fed vag kilo">
								...
								<div class="nho">
									@if ($user->get_latest_kyc()->knowledge_trading == 0 )
									...
									<div class="abig">
										<label class="switch oldswitch ">
											@if ($user->get_latest_kyc()->knowledge_trading)
								...
								<div class="row">
									<div class="col-12">
										<div class="df sut">
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_size == 1)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_size == 2)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_size == 3)
								...
								<div class="row">
									<div class="col-12">
										<div class="df sut">
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_frequency == 1)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_frequency == 2)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_frequency == 3)
								...
								<div class="row">
									<div class="col-12">
										<div class="df sut">
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_duration == 1)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_duration == 2)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_listed_duration == 3)
							...
							<div class="df fed vag">
								...
								<div class="nho">
									@if ($user->get_latest_kyc()->knowledge_trading_unlisted == 0)
										<div class="biz a14m mr20 active">NEJ</div>
									@else
										<div class="biz a14m mr20">NEJ</div>
									@endif
									<div class="abig">
										<label class="switch oldswitch">
											@if ($user->get_latest_kyc()->knowledge_trading_unlisted)
								...
								<div class="row">
									<div class="col-12">
										<div class="df sut">
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_size == 1)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_size == 2)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_size == 3)
								...
								<div class="row">
									<div class="col-12">
										<div class="df sut">
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_frequency == 1)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_frequency == 2)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_frequency == 3)
								...
								<div class="row">
									<div class="col-12">
										<div class="df sut">
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_duration == 1)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_duration == 2)
											...
											<div>
												<label>
													@if ($user->get_latest_kyc()->trading_unlisted_duration == 3)
							...
							<div class="df fed vag">
								...
								<div class="nho">
									@if ($user->get_latest_kyc()->knowledge_company_financial_information == 0)
									<div class="biz a14m mr20 active">NEJ</div>
									@else
									<div class="biz a14m mr20">NEJ</div>
									@endif
									<div class="abig">
										<label class="switch oldswitch">
											@if ($user->get_latest_kyc()->knowledge_company_financial_information)
							...
							<div class="df fed vag">
								...
								<div class="nho">
									@if ($user->get_latest_kyc()->eduction_profession_understand_risks == 0)
									<div class="biz a14m mr20 active">NEJ</div>
									@else
									<div class="biz a14m mr20">NEJ</div>
									@endif
									<div class="abig">
										<label class="switch oldswitch">
											@if ($user->get_latest_kyc()->eduction_profession_understand_risks)
							...
							<div class="df fed vag">
								...
								<div class="nho">
									@if ($user->get_latest_kyc()->accepts_terms == 0)
									<div class="biz a14m mr20 active">NEJ</div>
									@else
									<div class="biz a14m mr20">NEJ</div>
									@endif
									<div class="abig">
										<label class="switch oldswitch">
											@if ($user->get_latest_kyc()->accepts_terms)
							...
							<div class="df fed vag mb70">
								...
								<div class="nho">
									@if ($user->get_latest_kyc()->aware_of_risks == 0)
									<div class="biz a14m mr20 active">NEJ</div>
									@else
									<div class="biz a14m mr20">NEJ</div>
									@endif
									<div class="abig">
										<label class="switch oldswitch">
											@if ($user->get_latest_kyc()->aware_of_risks)
							...
							<p class="a18l il mb70">Enligt lagen om åtgärder mot penningtvätt och finansiering av terrorism (2009:62) samt Finansinspektionens föreskrifter (FFFS 2009:1) är Pepins skyldig att lära känna sina kunder för att förstå syftet med affärstransaktionen och affärsförhållandet samt göra en bedömning av risker för att Pepins utnyttjas för penningtvätt och finansiering av terrorism. Vi ber dig därför att svara på nedanstående frågor.</p>
							<div class="fg1 mb70">
								<div class="fed dif df kilo">
									...
									@if ($user->get_latest_kyc()->pep  && !$user->get_latest_kyc()->accept_pep)
										<div style="color:red;">Du har valt PEP. Kontakta Pepins för att investera.</div>
									@endif
									</div>
									<div>
										<div class="nho">
											@if ($user->get_latest_kyc()->pep == 0)
												<div class="biz a14m mr20 active">NEJ</div>
											@else
												<div class="biz a14m mr20">NEJ</div>
											@endif
								...
								<div class="fed dif">
									...
									@if ($user->get_latest_kyc()->related_to_pep  && !$user->get_latest_kyc()->accept_pep)
										<div style="color:red;">Du har valt närstående till PEP. Kontakta Pepins för att investera.</div>
									@endif
									</div>
									<div>
										<div class="nho">
											@if ($user->get_latest_kyc()->related_to_pep == 0)
												<div class="biz a14m mr20 active">NEJ</div>
											@else
												<div class="biz a14m mr20">NEJ</div>
											@endif
											<div class="abig">
												<label class="switch oldswitch">
													@if ($user->get_latest_kyc()->related_to_pep)
							...
							@if ($user->get_latest_kyc()->accept_pep)
							<div class="fed dif">
									<div class="a14r ghg">
										<div style="color:red;">Pepins har godkänt din KYC.</div>
									@if (isset($user->get_latest_kyc()->accept_pep_comment))
										<div style="color:red;">Med följande kommentar:</div>
										<div style="color:red;">{{$user->get_latest_kyc()->accept_pep_comment}}</div>
									@endif
									</div>
							</div>
							@endif
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'salery')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="salery" value="salery" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="salery" value="salery">
													@endif
												</div>
												<span>Lön</span>
											</label>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'pension')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="pension" value="pension" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="pension" value="pension">
													@endif
												</div>
												<span>Pension</span>
											</label>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'savings')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="savings" value="savings" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="savings" value="savings">
													@endif
												</div>
												<span>Sparande</span>
											</label>
										...
										<div>
											<label class="df vo a12r boso">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'investable_funds')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="investable_funds" value="investable_funds" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="investable_funds" value="investable_funds">
													@endif
												</div>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'inheritance')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="inheritance" value="inheritance" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="inheritance" value="inheritance">
													@endif
												</div>
												<span>Arv</span>
											</label>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'dividends')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="dividends" value="dividends" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="dividends" value="dividends">
													@endif
												</div>
												<span>Utdelning</span>
											</label>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'housing')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="housing" value="housing" checked>
													@else
														<input type="checkbox" name="investable_funds_origin[]" id="housing" value="housing">
													@endif
												</div>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'gambling')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="gambling" value="gambling" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="gambling" value="gambling">
													@endif
												</div>
												<span>Spelvinst</span>
											</label>
										...
										<div>
											<label class="df vo a12r">
												<div class="check-wrap pr">
													...
													@if ((strpos($user->get_latest_kyc()->investable_funds_origin, 'other')) !== false)
														 <input type="checkbox" name="investable_funds_origin[]" id="other" value="other" checked>
													@else
														 <input type="checkbox" name="investable_funds_origin[]" id="other" value="other">
													@endif
												</div>
												<span>Annat</span>
											</label>
							...
							<div class="row">
								<div class="col-12">
									<div class="df sut saika">
										<div>
											<label>
												@if ($user->get_latest_kyc()->salary_yearly == 1)
										...
										<div>
											<label>
												@if ($user->get_latest_kyc()->salary_yearly == 2)
										...
										<div>
											<label>
												@if ($user->get_latest_kyc()->salary_yearly == 3)
										...
										<div>
											<label for="var4">
												@if ($user->get_latest_kyc()->salary_yearly == 4)
							...
							<div class="row">
								<div class="col-12">
									<div class="df sut saika">
										<div>
											<label>
												@if ($user->get_latest_kyc()->investment_size_yearly == 1)
										...
										<div>
											...
											<label>
												@if ($user->get_latest_kyc()->investment_size_yearly == 2)
										...
										<div>
											<label>
												@if ($user->get_latest_kyc()->investment_size_yearly == 3)
										...
										<div>
											<label>
												@if ($user->get_latest_kyc()->investment_size_yearly == 4)
